...
6. Let's look closer at the column types as it is important that variables are coded appropriately for further statistical analysis. This is not yet the case with our weather data. Recall that functions such `as.numeric()` and `as.character()` can be used to coerce variables into different types. 
